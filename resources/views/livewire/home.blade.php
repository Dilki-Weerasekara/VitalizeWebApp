                ...
                <div class="col-xl-8 col-xxl-9 col-lg-8">
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3">
                        ...
                        <div class="card-body d-flex p-0 mt-0">
                            ...
                            {{-- <a href="#" class="d-flex align-items-center font-xssss fw-600 ls-1 text-grey-700 text-dark pe-4"><i class="font-md text-warning me-2" style="margin-top: -10px">{!! $icons->getIcon('camera') !!}</i><span class="d-none-xs">Feeling/Activity</span></a> --}}
