                ...
                <div class="col-xl-4 col-xxl-3 col-lg-4 pe-0">
                    <div class="mb-3 border-0 card w-100 shadow-xss rounded-xxl">
                        <div class="p-4 card-body d-block">
                            ...
                            <p class="mb-0 fw-500 text-grey-500 lh-24 font-xssss" >{{ $user->description ?? 'Your Address' }}</p>
                        </div>
                        ...
                        <div class="pt-0 card-body d-flex">
                            ...
                            <h4 class="mt-1 fw-700 text-grey-900 font-xssss" >{{ $user->location ?? 'Your Location' }} </h4>
                        </div>
