                            ...
                            <div class="row row-cols-1 row-cols-md-2 g-4 mt-3 mb-4">
                                <div class="col">
                                  <div class="card h-100">
                                    ...
                                    <div class="card-footer ">
                                            <a class="btn btn-warning col-12" href="{{ route('user_cognitive_exercises') }}" role="button">Click Here to Explore More...</a>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-footer ">
                                              <a class="btn btn-warning col-12" href="{{ route('user_mindfulness_practices') }}" role="button">Click Here to Explore More...</a>
                                      </div>
                                    </div>
                                  </div>
                                ...
                                <div class="col">
                                    <div class="card h-100">
                                      ...
                                      <div class="card-footer ">
                                            <a class="btn btn-warning col-12" href="{{ route('user_awareness_programs') }}" role="button">Click Here to Explore More...</a>
                                      </div>
                                    </div>
                                </div>
